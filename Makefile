...
BONUS_SRC = bonus/checker_bonus.c bonus/get_next_line_bonus.c bonus/get_next_line_utils_bonus.c \
			ft_atoi.c ft_lstadd_back.c ft_split.c utils.c Moves/ft_push.c \
			Moves/ft_rotate.c Moves/ft_rrotate.c Moves/ft_swap.c bonus/ft_execute_moves.c \
			bonus/ft_result.c algo/is_sorted.c
